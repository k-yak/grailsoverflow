...
<body>
	<div id='login'>
      ...
      <div class="error">
        ...
        <p><g:message code="grow.oauth.confirm.access.pbm" />. (${lastException?.message})</p>
      </div>
	</g:if>
		<g:else>
			...
			<div><g:message code="grow.oauth.confirm.you.auth" /> <b>${applicationContext.getBean('clientDetailsService')?.loadClientByClientId(params.client_id)?.clientId ?: 'n/a'}</b><g:message code="grow.oauth.confirm.to.access" />.</div>
